	...
	<section>
		...
		<section>
			<form action="signUp" method="post">
				<div>
					<label>이메일</label><br>
					<input name="email" type="email" placeholder="email을 입력하세요"><br>
					<label>이름</label><br>
					...
					<label>전화번호</label><br>
					<input name="phone" type="number" placeholder="휴대폰번호(‘-’ 없이 입력)"><br>
				</div>


				<div>
					<input name="event_agree" type="checkbox" value="Y" checked>
					<span>펀딩 소식과 이벤트 안내를 받습니다(선택)</span> <br> <span>본인은 만
						14세 이상이며 회원기본약관, 이용약관, 개인정보처리방침 내용에 동의합니다.</span>
				</div>

				<div>
					<input class="signUp" type="submit" value="가입하기"> <br>
					<a href="/blackswan2/index">홈으로 돌아가기</a>
				</div>
			</form>
		</section>
